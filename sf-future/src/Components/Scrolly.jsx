  ...
  return (
    <div>
          ...
          <div className="relative">
            <div className="relative z-10 max-w-2xl md:max-w-4xl mx-auto px-4 opacity-[99] transform-gpu [-webkit-transform:translate3d(0,0,0)]">
                {children}
            </div>
          </div>
        </div>
    ...
    <div>
      ...
      <div className="relative">
        <div className="relative z-20 max-w-2xl md:max-w-4xl mx-auto px-4 opacity-[99] transform-gpu [-webkit-transform:translate3d(0,0,0)]">
            {children}
        </div>
      </div>
    </div>
