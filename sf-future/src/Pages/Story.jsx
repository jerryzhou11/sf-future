  ...
  const profiles = [
    {
      ...
      content: (
        <div className="space-y-4 text-left lg:flex gap- justify-start items-start">
          <img src={Ana} alt="Analuisa Casimir" className="rounded-lg lg:h-fit object-cover" />
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-left lg:flex gap-4">
          <img src={Jess} alt="Jess Kitchingman" className="lg:sticky top-0 rounded-lg lg:h-fit object-cover" />
          <div className="flex flex-col gap-8">
          <p className="text-lg">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-left lg:flex gap-4">
          <img src={Lei} alt="Lei Levy" className="lg:sticky top-0 rounded-lg lg:h-fit object-cover" />
          <div className="flex flex-col gap-8">
          <p className="text-lg">
